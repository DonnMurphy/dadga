...
const account1 = '0x1B6e1cdF8cBDac646dD548E46B8FE0A8b7B72852'; // Your account address 1
...
function getAllSheep() {
  var sheepArr = []
  var totalSheep = contract.methods.getSheepTotal().call((err,result) => { totalSheep = result}).then( total => {
...
console.log("ABI" ,mabi)
contract.methods.getSheepById(0).call((err, resulta) => {console.log(resulta)});
console.log("Is there something here" + getAllSheep());
console.log(createNewSheep("Michael Maaartin"));
